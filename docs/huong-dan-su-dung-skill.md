...
2. **AI hỏi gộp một lần** toàn bộ thông tin còn thiếu (đánh số 1, 2, 3...) — không hỏi từng câu một. Bạn trả lời gộp theo đúng thứ tự để AI xử lý nhanh nhất, ví dụ:
   > AI hỏi: `1. Họ tên viên chức? 2. Ngày sinh? 3. Chức danh?`
   > Bạn trả lời: `1=Nguyễn Thị Lan, 2=15/03/1968, 3=Điều dưỡng viên chính`
...
QLCL **chưa có mẫu `.docx` tích hợp sẵn** — AI trả lời bằng văn bản soạn sẵn đúng thể thức hành chính; bạn copy nội dung đó rồi dán vào mẫu Word của phòng đang dùng.
...
NCKH&HTQT **chưa có mẫu `.docx` tích hợp sẵn** (nguồn hồ sơ toàn PDF đã ký, không có mẫu trống) — AI luôn trả lời bằng văn bản soạn sẵn đúng thể thức, bạn copy dán vào mẫu Word của phòng. ⚠️ Luôn xác nhận số hiệu Luật Khoa học, Công nghệ hiện hành (số 93/2025/QH15) — hồ sơ mẫu cũ của phòng có lẫn trích dẫn luật đã hết hiệu lực (29/2013/QH13).

---

## 4. Dùng AI cho các việc không cần soạn văn bản theo mẫu

Các lệnh `/phong-*` ở mục 3 chỉ dành cho **soạn giấy tờ theo mẫu chuẩn** của từng phòng. Rất nhiều việc hàng ngày không cần mẫu — AI vẫn hỗ trợ được, dùng thẳng như hỏi một trợ lý bình thường: gõ câu hỏi tự nhiên, không cần nhắc tên phòng hay dùng lệnh `/`.
